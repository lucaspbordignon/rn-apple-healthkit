...
{
    HKQuantityType *inhalerUsageType = [HKQuantityType quantityTypeForIdentifier:HKQuantityTypeIdentifierInhalerUsage];
    ...
    [self fetchQuantitySamplesOfType:inhalerUsageType
                                unit:unit
                           predicate:predicate
                           ascending:ascending
                               limit:limit
