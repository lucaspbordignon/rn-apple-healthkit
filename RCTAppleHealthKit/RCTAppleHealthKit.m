...
RCT_EXPORT_METHOD(getHeartRateHourlySamples:(NSDictionary *)input callback:(RCTResponseSenderBlock)callback)
{
    [self vitals_getHeartRateHourlySamples:input callback:callback];
}
