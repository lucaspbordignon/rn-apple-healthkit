...
RCT_EXPORT_METHOD(getNutritionDailySamples:(NSDictionary *)input callback:(RCTResponseSenderBlock)callback)
{
    [self getNutritionDailySamples:input callback:callback];
}
